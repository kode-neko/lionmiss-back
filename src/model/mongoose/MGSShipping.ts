...
type ModelLMShipping = Document<unknown, unknown, LMShipping> & Omit<LMShipping & Required<{ _id: string; }>, never>;
class MGSShipping implements IShipping {
  ShippingModel: Model<LMShipping> = model<LMShipping>("Shipping", schemaShipping, "shipping");
  ...
  getShippingAll({limit, offset, search = {}}: LMBSearchParams): Promise<LMShipping[]> {
